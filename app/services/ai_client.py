...
class AIClient:
    ...
    def _mock_outline(self, user_prompt: str) -> dict[str, Any]:
        ...
        return {
            "full_outline": (
                ...
                "第四阶段收束主线问题，关键伏笔被重新解释，人物成长完成最终转折。结局依靠已经建立的规则、关系和代价完成最终解决，禁止临时新增设定。"
            ),
            "volume_outline": [
                {
                    "volume_number": 1,
            ...
            chapters.append(
                {
                    ...
                    "new_information": f"{title}指向阶段主线中的关键拼图。",
    ...
    def _mock_chapter_text(self, user_prompt: str, chapter_number: int, title: str, seed: int) -> str:
        ...
        return (
            ...
            f"{protagonist}看着那行字，意识到真正的阻力落在每一条线索背后的代价上。"
